...
--
CREATE DATABASE IF NOT EXISTS `crop_prediction` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `crop_prediction`;
...
('5tr3me9rly8z1pd2mlifsbz12x9psktd', 'eyJ1c2VyaWQiOjJ9:1oawdN:GaMBN1N_SMZMB-Vf_GiZn6cZtx0PBbXppYxDkxo1XgM', '2022-10-05 10:07:13.491232'),
...
('uyb8dt2gnhly6v4s9erpkdsw0v92y7um', 'eyJ1c2VyaWQiOjF9:1oauKv:HbQYUy3dCU9_HvdQzmbixwUVXHkv4FmHc8gR4nr3eZA', '2022-10-05 07:40:01.714195'),
...
(1, 'Ramesh', 'Ramesh123@gmail.com', 'Ramesh', '9535866270', 'India', 'Karnataka', 'Bangalore', '#7827,4th Cross,Rajajinagar', 'Male'),
(2, 'Manjunath', 'tmksmanju13@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Vijaynagar', 'Male');
...
CREATE TABLE IF NOT EXISTS `remote_user_crop_prediction` (
  ...
  `Recommended_Zone` varchar(3000) NOT NULL,
  `Crop_Name` varchar(3000) NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `remote_user_crop_prediction` (`id`, `RID`, `N`, `P`, `K`, `temperature`, `humidity`, `ph`, `rainfall`, `Prediction`, `Recommended_Zone`, `Crop_Name`) VALUES
(1, '49nvudqj', '74', '35', '40', '26.49109635', '80.15836264', '6.980400905', '242.8640342', 'Suitable', 'Chhattisgarh, Bihar and Orissa under  both irrigated and rainfed conditions.', 'rice'),
(2, 'ps4y6kri', '66', '53', '41', '25.0756354', '80.52389148', '7.778915154', '257.0038865', 'Not Suitable', 'Rajasthan, Madhya Pradesh, Gujarat and Chhattisgarh in Kharif season under both irrigated and rainfed condition.', 'rice'),
(3, 'i44di6y3', '71', '54', '16', '22.61359953', '63.69070564', '5.749914421', '87.75953857', 'Suitable', 'Andhra Pradesh, Orissa, Assam, Maharashtra, Bihar and West Bengal under rainfed conditions.', 'maize'),
(4, 'o2uo0263', '68', '41', '16', '21.77689322', '57.80840636', '6.158830619', '102.0861694', 'Not Suitable', 'Uttar Pradesh, Haryana, Gujarat and Rajasthan under timely sowing, normal fertility and rainfed conditions', 'maize'),
(5, 'lfx2a3qi', '67', '60', '25', '24.92162194', '66.78627406', '5.750254943', '109.2162279', 'Suitable', 'Tamil Nadu, Karnataka, Maharashtra, Kerala, Interior Andhra Pradesh.', 'maize'),
(6, 'wbwb90h8', '27', '79', '82', '17.06579293', '17.54024066', '6.307004923', '70.87150577', 'Not Suitable', 'States of Uttarakhand, HP, J & K, Punjab, Haryana, Rajasthan, UP, MP, Chhattisgarh, Bihar, Jharkhand, West Bengal, Orissa, Assam, Gujarat and Maharashtra in irrigated summer and rainfed Kharif.', 'chickpea'),
(7, 'p2antw37', '93', '47', '37', '21.53346343', '82.14004101', '6.500343222', '295.9248796', 'Suitable', 'States of Uttarakhand, HP, J & K, Punjab, Haryana, Rajasthan, UP, MP, Chhattisgarh, Bihar, Jharkhand, West Bengal, Orissa, Assam, Gujarat and Maharashtra in irrigated summer and rainfed Kharif.', 'rice');
...
(53, 'Naive Bayes', '44.09090909090909'),
(54, 'SVM', '46.36363636363636'),
(55, 'Logistic Regression', '43.63636363636363'),
(56, 'Decision Tree Classifier', '46.13636363636363'),
(57, 'KNeighborsClassifier', '46.81818181818182'),
(58, 'Random Forest Classifier', '45.909090909090914');
...
(14, 'Not Suitable', '42.857142857142854'),
(15, 'Suitable', '57.14285714285714');
