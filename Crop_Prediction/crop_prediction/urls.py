...
from crop_prediction import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Crop_Type/$', remoteuser.Predict_Crop_Type, name="Predict_Crop_Type"),
    ...
    url(r'^View_Crop_Type_Ratio/$', serviceprovider.View_Crop_Type_Ratio, name="View_Crop_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Crop_Type/$', serviceprovider.View_Prediction_Of_Crop_Type, name="View_Prediction_Of_Crop_Type"),
